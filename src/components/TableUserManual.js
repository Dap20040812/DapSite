...
function TableUserManual() {
  return (
    <>
    <TableHeader/>
      <ManualPage>
        <Title>Descubre como utilizar correctamente todas las funcionalidades que Table tiene para ofrecerte.</Title>
...
export default TableUserManual
